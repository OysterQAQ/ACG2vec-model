...
model = keras.models.load_model('/Volumes/Data/oysterqaq/PycharmProjects/ACG2vec-model/deepix/model-resnet_custom_v3_float16.h5', compile=False)
...
style_feature_extract_model.save("/Volumes/Data/oysterqaq/Desktop/style_feature_extract_model_f16")
