...
model = keras.models.load_model('/Volumes/Home/oysterqaq/PycharmProjects/ACG2vec-model/pix2score/model-resnet_custom_v3.h5', compile=False)
...
x = model(x)
deepdanbooru_base64input = keras.Model(inputs=inputs, outputs=x)
deepdanbooru_base64input.summary()
...
deepdanbooru_base64input.save("/Volumes/Home/oysterqaq/Desktop/deepdanbooru_base64input")
