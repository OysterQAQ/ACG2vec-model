...
class UpCunet2x(tf.keras.layers.Layer):
    ...
    def call(self, inputs):
        ...
        return tf.cond(tile_mode == 0, lambda: self.forward_tile_0(x, ph, h0, pw, w0),
                       lambda: self.forward_with_tile(x, ph, h0, pw, w0, tile_mode, if_half))
        # return  self.forward_tile_0(x,ph,h0,pw,w0)
        # return self.forward_tile_not_0(x, ph, h0, pw, w0, tile_mode, if_half)


    def forward_tile_0_output_b64(self,x,ph,h0,pw,w0):
    ...
    def forward_with_tile(self,x,ph,h0,pw,w0,tile_mode,if_half):
...
#export(model,"tf_model/pro-no-denoise-up2x_without_tile_b64_in_bin_out")
# model=build_model("weights_pro/pro-denoise3x-up2x.pth")
# export(model,"tf_model/pro-denoise3x-up2x_without_tile_b64_in_bin_out")
# model=build_model("weights_pro/pro-conservative-up2x.pth")
# export(model,"tf_model/pro-conservative-up2x_without_tile_b64_in_bin_out")
