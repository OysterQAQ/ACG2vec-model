...
#    prediction = cunet(inputs)
#    return  prediction
# my_signatures = my_predict.get_concrete_function(
#    inputs=tf.TensorSpec([None,None,None,3], dtype=tf.dtypes.uint8, name="inputs")
# )
# tf.saved_model.save(
#     cunet,
#     export_dir="/Volumes/Home/oysterqaq/Desktop/test2",
#     signatures=my_signatures
# )

load_pt_weight_to_tf("weights_pro/pro-no-denoise-up2x.pth", cunet, "weight_map.json")
