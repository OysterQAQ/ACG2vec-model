        ...
        for i in range(0, h - 36, crop_size[0]):
            for j in range(0, w - 36, crop_size[1]):
                ...
                if (pro):
                    ...
                    res[:, :, i * 2:i * 2 + h1 * 2 - 72, j * 2:j * 2 + w1 * 2 - 72] = (x * 255).round().clamp_(0,
                                                                                                               255).byte()
        del tmp_dict
        ...
        for i in range(0, h - 36, crop_size[0]):
            for j in range(0, w - 36, crop_size[1]):
                ...
                if (pro):
                    ...
                    res[:, :, i * 2:i * 2 + h1 * 2 - 72, j * 2:j * 2 + w1 * 2 - 72] = (x_crop * 255.0).round().clamp_(0,
                                                                                                                      255).byte()
        # torch.cuda.empty_cache()
        if (w0 != pw or h0 != ph): res = res[:, :, :h0 * 2, :w0 * 2]
        return res
        ...
        for i in range(0, h - 28, crop_size[0]):
            for j in range(0, w - 28, crop_size[1]):
                ...
                if (pro):
                    ...
                    res[:, :, i * 3:i * 3 + h1 * 3 - 84, j * 3:j * 3 + w1 * 3 - 84] = (x * 255).round().clamp_(0,
                                                                                                               255).byte()
        del tmp_dict
        # torch.cuda.empty_cache()
        ...
        for i in range(0, h - 28, crop_size[0]):
            for j in range(0, w - 28, crop_size[1]):
                ...
                if (pro):
                    ...
                    res[:, :, i * 3:i * 3 + h1 * 3 - 84, j * 3:j * 3 + w1 * 3 - 84] = (x_crop * 255.0).round().clamp_(0,
                                                                                                                      255).byte()
        # torch.cuda.empty_cache()
        if (w0 != pw or h0 != ph): res = res[:, :, :h0 * 3, :w0 * 3]
        return res
        ...
        for i in range(0, h - 38, crop_size[0]):
            for j in range(0, w - 38, crop_size[1]):
                ...
                if (pro):
                    ...
                    res[:, :, i * 4:i * 4 + h1 * 4 - 152, j * 4:j * 4 + w1 * 4 - 152] = (x * 255).round().clamp_(0,
                                                                                                                 255).byte()
        del tmp_dict
        # torch.cuda.empty_cache()
        ...
        for i in range(0, h - 38, crop_size[0]):
            for j in range(0, w - 38, crop_size[1]):
                ...
                if (pro):
                    ...
                    res[:, :, i * 4:i * 4 + h1 * 4 - 152, j * 4:j * 4 + w1 * 4 - 152] = (x_crop * 255).round().clamp_(0,
                                                                                                                      255).byte()
        # torch.cuda.empty_cache()
        if (w0 != pw or h0 != ph): res = res[:, :, :h0 * 4, :w0 * 4]
        return res
